...
(function() {
    ...
    var ground = {
        ...
        init : function(drawingState) {
            ...
            var opt = {color:[0,0,0,1], src:"Things/lawn0.jpg"};
            texture = twgl.createTexture(gl);
		        twgl.loadTextureFromUrl(gl, texture, opt, function(err, tex, img) {
        ...
        draw : function(drawingState) {
            ...
            twgl.setBuffersAndAttributes(gl,shaderProgram,buffers);
			      ...
			      twgl.setUniforms(shaderProgram, {lightdir: drawingState.sunDirection, uTexture: texture, sunView: drawingState.sunView, sunProj: drawingState.sunProj});
