...
var emptyTexture = gl.createTexture();
	...
	var shadowFB = gl.createFramebuffer();
    ...
    function draw() {
        ...
        var cameraM = twgl.m4.lookAt(lookFrom,lookAt,[0,4,0]);
        ...
        var sunDirection = [Math.cos(sunAngle),Math.sin(sunAngle),0];
		    ...
		    var sunProj = twgl.m4.perspective(0.7, 1, 15, 40);
    ...
    gl.clear(gl.COLOR_BUFFER_BIT | gl.DEPTH_BUFFER_BIT);
		...
		drawingState.depthTexture = depthTexture;
